 ...
 */
          ...
          } else if (unlikely(__pyx_t_23 >= __pyx_v_D.shape[0])) __pyx_t_14 = 0;
          if (__pyx_t_24 < 0) {
            __pyx_t_24 += __pyx_v_D.shape[1];
            if (unlikely(__pyx_t_24 < 0)) __pyx_t_14 = 1;
          } else if (unlikely(__pyx_t_24 >= __pyx_v_D.shape[1])) __pyx_t_14 = 1;
          if (unlikely(__pyx_t_14 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_14);
          ...
          __pyx_t_14 = -1;
          if (__pyx_t_29 < 0) {
            __pyx_t_29 += __pyx_v_eri.shape[0];
            if (unlikely(__pyx_t_29 < 0)) __pyx_t_14 = 0;
          } else if (unlikely(__pyx_t_29 >= __pyx_v_eri.shape[0])) __pyx_t_14 = 0;
          if (__pyx_t_30 < 0) {
            __pyx_t_30 += __pyx_v_eri.shape[1];
            if (unlikely(__pyx_t_30 < 0)) __pyx_t_14 = 1;
          } else if (unlikely(__pyx_t_30 >= __pyx_v_eri.shape[1])) __pyx_t_14 = 1;
          if (__pyx_t_31 < 0) {
            __pyx_t_31 += __pyx_v_eri.shape[2];
            if (unlikely(__pyx_t_31 < 0)) __pyx_t_14 = 2;
          } else if (unlikely(__pyx_t_31 >= __pyx_v_eri.shape[2])) __pyx_t_14 = 2;
          if (__pyx_t_32 < 0) {
            __pyx_t_32 += __pyx_v_eri.shape[3];
            if (unlikely(__pyx_t_32 < 0)) __pyx_t_14 = 3;
          } else if (unlikely(__pyx_t_32 >= __pyx_v_eri.shape[3])) __pyx_t_14 = 3;
          if (unlikely(__pyx_t_14 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_14);
            __PYX_ERR(0, 37, __pyx_L1_error)
          }
          ...
          __pyx_t_14 = -1;
          if (__pyx_t_33 < 0) {
            __pyx_t_33 += __pyx_v_Fock_view.shape[0];
            if (unlikely(__pyx_t_33 < 0)) __pyx_t_14 = 0;
          } else if (unlikely(__pyx_t_33 >= __pyx_v_Fock_view.shape[0])) __pyx_t_14 = 0;
          if (__pyx_t_34 < 0) {
            __pyx_t_34 += __pyx_v_Fock_view.shape[1];
            if (unlikely(__pyx_t_34 < 0)) __pyx_t_14 = 1;
          } else if (unlikely(__pyx_t_34 >= __pyx_v_Fock_view.shape[1])) __pyx_t_14 = 1;
          if (unlikely(__pyx_t_14 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_14);
            __PYX_ERR(0, 37, __pyx_L1_error)
          }
          *((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_Fock_view.data + __pyx_t_33 * __pyx_v_Fock_view.strides[0]) )) + __pyx_t_34)) )) += ((*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_D.data + __pyx_t_23 * __pyx_v_D.strides[0]) )) + __pyx_t_24)) ))) * ((2.0 * (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_eri.data + __pyx_t_25 * __pyx_v_eri.strides[0]) ) + __pyx_t_26 * __pyx_v_eri.strides[1]) ) + __pyx_t_27 * __pyx_v_eri.strides[2]) )) + __pyx_t_28)) )))) - (*((double *) ( /* dim=3 */ ((char *) (((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_eri.data + __pyx_t_29 * __pyx_v_eri.strides[0]) ) + __pyx_t_30 * __pyx_v_eri.strides[1]) ) + __pyx_t_31 * __pyx_v_eri.strides[2]) )) + __pyx_t_32)) )))));
        }
      }
    }
  }
